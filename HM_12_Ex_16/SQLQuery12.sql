...
--2.fn_GetMasterSchedule - Возвращает расписание тренера на период:
		--Принимает @MasterId, @StartDate, @EndDate. Возвращает таблицу с событиями, классами и временными слотами, где занят тренер.
