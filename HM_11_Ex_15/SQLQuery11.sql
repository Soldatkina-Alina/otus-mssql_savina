...
-- 4. ќсновные (Main) - создаем сначала Locations и Events, так как на них есть ссылки
...
-- 5.‘инансы Finance (создаем после Events)
CREATE TABLE [Order] (
...
--Ћучше сделать составным, так как будут использоватьс¤ всегда в св¤зке
